    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-calendar"></i> 产品分类模块编辑
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    import { editStyleModuleOne,getStyleModuleOne,addStyleModuleOne } from '../../api/index';
        ...
        methods: {
            ...
            onSubmit() {
                if(this.flag_){
                    ...
                    editStyleModuleOne(this.form).then(res => {
                        if(res.code == 0){
                    ...
                    this.proData = ''
                    this.editVisible = false
                    addStyleModuleOne(this.form).then(res => {
                        if(res.code == 0){
                            this.$message.success(`修改成功`);
                            this.$router.go(-1)
                        }else{
