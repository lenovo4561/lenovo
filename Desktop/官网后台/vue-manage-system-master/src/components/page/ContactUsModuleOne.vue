    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-calendar"></i> Banner图编辑
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="form-box">
                ...
                <el-form ref="form" :model="form" label-width="80px" style="margin-top: 50px">
                    ...
                    <el-form-item label="图片关键字" label-width="100px">
...
<script>
    import { editContactusModuleOne,getContactusModuleOne,addContactusModuleOne } from '../../api/index';
    import UploadComponent from '../common/Upload'
    import VueEditorComponent2 from '../common/VueEditor2'
    import bus from '../common/bus';
    export default {
        name: 'ContactUsModuleOne',
        components: {
            UploadComponent,
            VueEditorComponent2
        },
        ...
        methods: {
            ...
            getData() {
                getContactusModuleOne().then(res => {
                    if(res.code == 0){
                        this.flag_ = true
            ...
            onSubmit() {
                if(this.flag_){
                    ...
                    editContactusModuleOne(this.form).then(res => {
                        if(res.code == 0){
                    ...
                    this.proData = ''
                    this.editVisible = false
                    addContactusModuleOne(this.form).then(res => {
                        if(res.code == 0){
                            this.$message.success(`修改成功`);
                            this.$router.go(-1)
                        }else{
